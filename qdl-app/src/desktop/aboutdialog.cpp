    ...
    QDialog(parent)
{
    ...
    QPushButton *donateButton = new QPushButton(QIcon::fromTheme("application-community"), tr("Donate"), this);
    QPushButton *bugButton = new QPushButton(QIcon::fromTheme("mail-forward"), tr("Report bug"), this);
...
void AboutDialog::reportBug() {
    QDesktopServices::openUrl(QUrl("mailto:showarth@marxoft.co.uk?subject=QDL " + VERSION_NUMBER));
    this->accept();
}
