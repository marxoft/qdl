...
void Netload::getCaptcha(const QString &key) {
    this->setChallenge(key);
    QUrl url("http://netload.in/share/includes/captcha.php?t=" + key);
...
void Netload::onCaptchaDownloaded() {
...
void Netload::reportError(int errorCode) {
    switch (errorCode) {
    case 404:
...
Q_EXPORT_PLUGIN2(netloadrecaptcha, Netload)
#endif
