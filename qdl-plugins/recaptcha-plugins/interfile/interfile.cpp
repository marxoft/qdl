...
void Interfile::getCaptcha(const QString &key) {
    this->setChallenge(key);
    QUrl url(QString("http://interfile.net/captchas/%1.jpg").arg(key));
...
void Interfile::onCaptchaDownloaded() {
...
void Interfile::reportError(int errorCode) {
    switch (errorCode) {
    case 404:
...
Q_EXPORT_PLUGIN2(interfilerecaptcha, Interfile)
