...
class SecureUpload : public RecaptchaPlugin
{
    Q_OBJECT
    Q_INTERFACES(RecaptchaInterface)
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "org.qdl.SecureUploadRecaptcha")
#endif

public:
    explicit SecureUpload(QObject *parent = 0);
    inline RecaptchaPlugin* createRecaptchaPlugin() { return new SecureUpload; }
