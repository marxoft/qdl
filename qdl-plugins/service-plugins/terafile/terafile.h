...
class Terafile : public ServicePlugin
{
    Q_OBJECT
    Q_INTERFACES(ServiceInterface)
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "org.qdl.Terafile")
#endif

public:
    explicit Terafile(QObject *parent = 0);
    ServicePlugin* createServicePlugin() { return new Terafile; }
    inline QString iconName() const { return QString("terafile.jpg"); }
    inline QString serviceName() const { return QString("Terafile"); }
