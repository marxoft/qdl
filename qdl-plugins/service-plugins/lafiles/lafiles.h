...
class Lafiles : public ServicePlugin
{
    Q_OBJECT
    Q_INTERFACES(ServiceInterface)
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "org.qdl.Lafiles")
#endif

public:
    explicit Lafiles(QObject *parent = 0);
    ServicePlugin* createServicePlugin() { return new Lafiles; }
    inline QString iconName() const { return QString("lafiles.jpg"); }
    inline QString serviceName() const { return QString("Lafiles"); }
