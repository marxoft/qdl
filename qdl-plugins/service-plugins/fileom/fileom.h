...
class FileOM : public ServicePlugin
{
    Q_OBJECT
    Q_INTERFACES(ServiceInterface)
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "org.qdl.FileOM")
#endif

public:
    explicit FileOM(QObject *parent = 0);
    ServicePlugin* createServicePlugin() { return new FileOM; }
    inline QString iconName() const { return QString("fileom.jpg"); }
    inline QString serviceName() const { return QString("FileOM"); }
