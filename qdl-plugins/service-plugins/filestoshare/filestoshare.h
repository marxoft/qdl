...
#ifndef FILESTOSHARE_H
#define FILESTOSHARE_H
...
class FilesToShare : public ServicePlugin
{
    Q_OBJECT
    Q_INTERFACES(ServiceInterface)
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "org.qdl.FilesToShare")
#endif

public:
    explicit FilesToShare(QObject *parent = 0);
    ServicePlugin* createServicePlugin() { return new FilesToShare; }
    inline QString iconName() const { return QString("filestoshare.jpg"); }
    inline QString serviceName() const { return QString("FilesToShare"); }
