...
class Interfile : public ServicePlugin
{
    Q_OBJECT
    Q_INTERFACES(ServiceInterface)
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "org.qdl.Interfile")
#endif

public:
    explicit Interfile(QObject *parent = 0);
    ServicePlugin* createServicePlugin() { return new Interfile; }
    inline QString iconName() const { return QString("interfile.jpg"); }
    ...
    inline QString recaptchaServiceName() const { return QString("Interfile"); }
